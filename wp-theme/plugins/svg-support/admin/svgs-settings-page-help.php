...
function bodhi_svgs_help_tab () {
	...
	$bodhi_svgs_help_tab_usage_standard .= '<p>' . __( 'You can simply upload SVG files to your media library like any other image. Make sure to select "Restrict to ***REMOVED***" if you only want to allow admins to upload SVG files.', 'svg-support' ) . '</p>';
