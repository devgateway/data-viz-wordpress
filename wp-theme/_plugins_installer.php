...
function dg_semantic_recommended_plugins($plugins) {
    $theme_plugins = array(
        ...
        'wordpress-seo' => array(
            'name' => esc_attr__('WordPress SEO by Yoast', 'dg-semantic' ),
            'slug' => 'wordpress-seo',
        ...
        'wp-react-custom-multilang' => array(
            ...
            'file' => 'wp-react-custom-multilang/wp-react-custom-multilang.php',
            'category' => 'Multilingual',
            'required' => true,
            'featured' => true,
            'is_local' => true,
            'source' => plugin_dir_path(__FILE__) . 'wp-react-custom-multilang/wp-react-custom-multilang.php',
        ),
        ...
        'menu-image' => array(
            'name' => esc_attr__('Menu Image', 'dg-semantic'),
            'slug' => 'menu-image',
