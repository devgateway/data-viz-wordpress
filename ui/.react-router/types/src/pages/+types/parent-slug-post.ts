...
type Module = typeof import("../parent-slug-post")

export type Info = {
  parents: [Parent0, Parent1],
  id: "pages/parent-slug-post"
  file: "./pages/parent-slug-post.tsx"
  path: ":parent/:year/:month/:day/:slug"
  params: {"lan": string; "parent": string; "year": string; "month": string; "day": string; "slug": string}
  module: Module
