...
const Format = ({format, title, ***REMOVED***}) => {


    const ***REMOVED*** = (style) => {
        ***REMOVED***(Object.assign({}, format, {style}))
    }

    const ***REMOVED*** = (value) => {
        ***REMOVED***(Object.assign({}, format, {
            minimumFractionDigits: value,
            maximumFractionDigits: value
        }))
    }
    const ***REMOVED*** = (currency) => {
        
        ***REMOVED***(Object.assign({}, format, {currency}))
    }
