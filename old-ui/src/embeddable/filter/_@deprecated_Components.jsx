...
const connected = (fn) => {
    ...
    return connect(***REMOVED***, ***REMOVED***)(injectIntl(fn))
}
...
export const ***REMOVED*** = (({options, placeholder, selected, icon = 'filter', onChange}) => {
...
export const PngExport = ({id, icon, name, filters = [], includes = [], size}) => {
    ...
    return (<Icon name={icon} size={size} onClick={e => {
        ...
        toPng(exportable, {***REMOVED***: "#FFF", filter: doFilter, style: {'border': '0px !important'}})
            .then(delay(1))
