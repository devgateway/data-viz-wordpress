            ...
            <Panel>
                <PanelBody>
                    ...
                    >
                        ...
                        {/* @ts-ignore */}
                        <PanelRow  style={{justifyContent: "end"}}>
                            <Button
                                isPrimary={true}
                                label={__('Apply')}
                                type="submit"
...
class BlockEdit extends BlockEditWithAPIMetadata<BlockEditProps, BlockEditWithAPIMetadataState> {

    constructor(props: BlockEditProps) {
        super(props);
    }
