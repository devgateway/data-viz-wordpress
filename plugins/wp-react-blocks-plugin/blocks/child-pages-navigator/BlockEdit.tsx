...
import { BlockEditWithAPIMetadata, ComponentWithSettings } from '@dg-data-viz/wordpress-commons'
...
class BlockEdit extends ComponentWithSettings<ChildPagesNavigatorProps, any> {
