...
class BlockEdit extends BlockEditWithAPIMetadata<MapBlockProps, MapBlockState> {
    ...
    ***REMOVED***(prevProps: MapBlockProps, prevState: MapBlockState, snapshot) {
    ...
    ***REMOVED***() {
        ...
        const taxonomyValuesOptions = ***REMOVED*** && ***REMOVED***.map(t => ({ label: t.name, value: t.id.toString(), taxonomy: t.taxonomy }))
