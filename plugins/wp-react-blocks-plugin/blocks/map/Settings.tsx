    ...
    render() {
        ...
        return (<PanelBody initialOpen={false} title={__("Settings")}>
            ...
            <PanelBody title={__("Labels")} initialOpen={false}>
                ...
                <PanelRow>
                    <ButtonGroup>
                        <Button variant={labelFontWeight == 'lighter' ? 'primary' : 'secondary'}
                            onClick={e => setAttributes({ labelFontWeight: "lighter" })}>
                            {__("Lighter")}
                        </Button>
                        <Button variant={labelFontWeight == 'normal' ? 'primary' : 'secondary'}
                            onClick={e => setAttributes({ labelFontWeight: "normal" })}>
                            {__("Normal")}
                        </Button>
                        <Button variant={labelFontWeight == 'bold' ? 'primary' : 'secondary'}
            ...
            <PanelBody title={__("Legend")} initialOpen={false}>
                ...
                <PanelRow>
                    <ButtonGroup>
                        ...
                        <Button variant={legendFontWeight == 'lighter' ? 'primary' : 'secondary'}
                            onClick={e => setAttributes({ legendFontWeight: "lighter" })}>
                            {__("Lighter")}
                        </Button>
                        <Button variant={legendFontWeight == 'normal' ? 'primary' : 'secondary'}
                            onClick={e => setAttributes({ legendFontWeight: "normal" })}>
                            {__("Normal")}
                        </Button>
                        <Button variant={legendFontWeight == 'bold' ? 'primary' : 'secondary'}
