...
const Chart = ({
    ...
    const CustomTick = (tick) => {
        ...
        if (***REMOVED***) {
            ***REMOVED*** = tickColor
            ...
            const legendItem: any = chartLegends.find((c:any) => c.id == tick.value)
    ...
    if (***REMOVED*** && overlays) {
            ...
            */
            ...
            if (showLine[idx] == true || showLine[idx] == undefined) {
                ...
                if (o.app == 'csv') {                    
                    const overlayData: ParseResult<any> = Papa.parse(***REMOVED***, {header: false, dynamicTyping: true});                    
    ...
    const legendItems = () => {
        ...
        return (<>
        {showLegends && chartLegends.map((legend: any) => {
            return (
        ...
        {showLegends && ***REMOVED*** && overlays.map((o, idx) => { 
            ...
            <label className={showLine[idx] ? "" : "ignore"} style={{
                ***REMOVED***: showLine[idx] && ***REMOVED*** == true ? o.lineColor: "none",
                color: ***REMOVED***
            }}>{o.title}</label>
            ...
            <>
                <ResponsiveBar
                    ...
                    ***REMOVED***={barLabelColor}
                    label={(l) => intl.formatNumber(format.style === 'percent' && l.value ? l.value / 100 : l.value, format)}
                    layers={layers}
