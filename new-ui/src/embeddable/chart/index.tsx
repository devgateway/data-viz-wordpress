...
import {buildDivergingOptions, ***REMOVED***, ***REMOVED*** } from './***REMOVED***'
                        ...
                        <***REMOVED***
                            ...
                            ***REMOVED***={***REMOVED*** == true || ***REMOVED*** == "true"}
                            ...
                            <ColorProvider
                                ...
                                options={{
                                    data: parse(measures),
                                    ***REMOVED***: parse(measures),
                                    ***REMOVED***: parse(measures),
                                    indexBy: dimensions[0],
                                    keys: ***REMOVED***,
                                }}
                                locale={locale}
                                overallLabel={overallLabel}
                                ...
                                barColor={chartProps.barColor}>
                                    { console.log("chartoption====>", chartProps)}
