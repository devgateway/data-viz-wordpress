...
class WPSEO_Taxonomy_Columns {
	...
	public function get_current_taxonomy() {
		// phpcs:disable WordPress.Security.***REMOVED***.Missing,WordPress.Security.***REMOVED***.Recommended -- Reason: We are not processing form information.
		...
		// phpcs:enable WordPress.Security.***REMOVED***.Missing,WordPress.Security.***REMOVED***.Recommended
		return null;
	}
