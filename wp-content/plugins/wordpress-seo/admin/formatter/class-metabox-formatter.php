...
class WPSEO_Metabox_Formatter {
	...
	private function get_defaults() {
		...
		return [
			...
			'***REMOVED***'               => WPSEO_Options::get( 'enable_cornerstone_content', false ) ? 1 : 0,
			...
			'***REMOVED***'              => WPSEO_Options::get( 'semrush_integration_active', true ) ? $this->get_semrush_login_status() : false,
			'showSocial'                      => [
			...
			'***REMOVED***'                 => $this->is_markdown_enabled(),
			'***REMOVED***'            => __( 'Analysis', 'wordpress-seo' ),
			...
			'***REMOVED***'              => ( $is_wincher_active ) ? YoastSEO()->helpers->wincher->login_status() : false,
			'***REMOVED***'                => WPSEO_Options::get( 'wincher_website_id', '' ),
	...
	private function get_content_analysis_component_translations() {
		...
		return [
			...
			'content-analysis.***REMOVED***'                => __( '***REMOVED***', 'wordpress-seo' ),
			...
			'content-analysis.***REMOVED***'                => __( 'Marks are disabled in current view', 'wordpress-seo' ),
	...
	private function get_translations() {
		...
		if ( file_exists( $file ) ) {
			// phpcs:ignore WordPress.WP.***REMOVED***.file_get_contents_file_get_contents -- Retrieving a local file.
	...
	/**
	 * Checks whether a multilingual plugin is currently active. Currently, we only check the following plugins: WPML, Polylang, and ***REMOVED***.
	 *
