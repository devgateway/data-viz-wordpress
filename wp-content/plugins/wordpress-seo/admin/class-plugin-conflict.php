...
class WPSEO_Plugin_Conflict extends Yoast_Plugin_Conflict {
	...
	public static function hook_check_for_plugin_conflicts( $plugin = false ) {
		...
		/* translators: %2$s expands to 'RS Head Cleaner' plugin name of possibly conflicting plugin with regard to ***REMOVED*** output between search engines and normal users. */
		$plugin_sections['cloaking'] = __( 'The plugin %2$s changes your site\'s output and in doing that ***REMOVED*** between search engines and normal users, a process that\'s called cloaking. We highly recommend that you disable it.', 'wordpress-seo' );
