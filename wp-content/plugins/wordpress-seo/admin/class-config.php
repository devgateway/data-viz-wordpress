...
class WPSEO_Admin_Pages {
	...
	public function config_page_scripts() {
		...
		$script_data = [
			'***REMOVED***'               => WPSEO_Language_Utils::get_language( \get_user_locale() ),
		...
		if ( $page === 'wpseo_titles' ) {
			...
			$script_data['***REMOVED***'] = [
				...
				'***REMOVED***'               => $this->should_show_local_seo_upsell(),
				'***REMOVED***'                => WPSEO_Shortlinker::get( 'https://yoa.st/3mp' ),
				'***REMOVED***'                => $this->should_show_news_seo_upsell(),
				'***REMOVED***'                 => WPSEO_Shortlinker::get( 'https://yoa.st/get-news-settings' ),
