...
if ( ! empty( $opengraph_disabled_alert ) ) {
	// phpcs:ignore WordPress.Security.EscapeOutput.***REMOVED*** -- Is correctly escaped in the generate_opengraph_disabled_alert() method.
	...
	// phpcs:ignore WordPress.Security.EscapeOutput.***REMOVED*** -- Is correctly escaped in the Badge_Presenter.
