...
echo '<p>';
printf(
	/* translators: %1$s / %2$s: links to the breadcrumbs ***REMOVED*** page on the Yoast knowledgebase */
	esc_html__( 'Usage of this breadcrumbs feature is explained in %1$sour knowledge-base article on breadcrumbs ***REMOVED***%2$s.', 'wordpress-seo' ),
