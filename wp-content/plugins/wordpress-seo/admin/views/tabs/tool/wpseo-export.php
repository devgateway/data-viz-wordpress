...
// phpcs:ignore WordPress.Security.***REMOVED***.Missing,WordPress.Security.ValidatedSanitizedInput.***REMOVED*** -- Reason: The nonce will be verified in WPSEO_Export below, We are only strictly comparing with '1'.
