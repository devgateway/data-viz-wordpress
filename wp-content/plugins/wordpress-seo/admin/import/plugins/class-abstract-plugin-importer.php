...
abstract class WPSEO_Plugin_Importer {
	...
	protected function meta_key_clone( $old_key, $new_key, $replace_values = [] ) {
		...
		$result = $wpdb->query(
			$wpdb->prepare(
				// phpcs:ignore WordPress.DB.***REMOVED***.SchemaChange -- This is intentional + temporary.
		...
		// phpcs:ignore WordPress.DB.***REMOVED***.SchemaChange -- This is intentional + a temporary table.
