(()=>{"use strict";var e={n:t=>{var n=t&&t.__esModule?()=>t.default:()=>t;return e.d(n,{a:n}),n},d:(t,n)=>{for(var o in n)e.o(n,o)&&!e.o(t,o)&&Object.***REMOVED***(t,o,{enumerable:!0,get:n[o]})},o:(e,t)=>Object.prototype.***REMOVED***.call(e,t)};const t=window.React,n=window.wp.element,o=window.yoast.***REMOVED***;var i=e.n(o);const a=window.wp.i18n,r=o.***REMOVED***`
	@media only screen and (min-width: 1024px) {
		.***REMOVED***.***REMOVED*** {
			${e=>"1"===e.isRtl?"left":"right"}: 340px !important;
		}
	}
`;function l(e){const t=document.createElement("div");t.setAttribute("id","yoast-helpscout-beacon"),(0,n.render)(e,t),document.body.appendChild(t)}function s(){return!!document.***REMOVED***("sidebar")}function c(e,n=""){!function(e,t){let n=e.Beacon||function(){};function o(){const e=t.***REMOVED***("script")[0],n=t.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://beacon-v2.helpscout.net",e.parentNode.insertBefore(n,e)}if(e.Beacon=n=function(t,n,o){e.Beacon.readyQueue.push({method:t,options:n,data:o})},n.readyQueue=[],"complete"===t.readyState)return o();e.attachEvent?e.attachEvent("onload",o):e.***REMOVED***("load",o,!1)}(window,document,window.Beacon),window.Beacon("init",e),function(e){""!==e&&(void 0!==(e=JSON.parse(e)).name&&void 0!==e.email&&(window.Beacon("prefill",{name:e.name,email:e.email}),delete e.name,delete e.email),window.Beacon("session-data",e))}(n),"1"===window.***REMOVED***.isRtl&&window.Beacon("config",{display:{position:"left"}}),s()&&l((0,t.createElement)(r,{isRtl:window.***REMOVED***.isRtl}))}window.***REMOVED***=c,window.wpseoHelpScoutBeaconConsent=function(e,o=null){const d=i().div`
		border-radius: 60px;
		height: 60px;
		position: fixed;
		transform: scale(1);
	...
	`;l((0,t.createElement)((()=>{const[i,l]=(0,n.useState)(!0),p=s();return(0,t.createElement)(n.Fragment,null,p&&(0,t.createElement)(r,{isRtl:window.***REMOVED***.isRtl}),i&&(0,t.createElement)(d,{className:p?"***REMOVED***":"",isRtl:window.***REMOVED***.isRtl},(0,t.createElement)(m,{type:"button",onClick:function(){const t=(0,a.__)("When you click OK we will open our HelpScout beacon where you can find answers to your questions. This beacon will load our support data and also potentially set cookies.","wordpress-seo");window.confirm(t)&&(c(e,o),window.Beacon("open"),window.setTimeout((()=>{l(!1)}),1e3))}},(0,t.createElement)(w,null))))}),null))}})();