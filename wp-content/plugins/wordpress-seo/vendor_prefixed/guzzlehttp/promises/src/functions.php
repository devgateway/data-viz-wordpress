 ...
 * settled ***REMOVED***. It will be automatically run when synchronously
 ...
 */
function queue(\YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $assign = null)
{
 ...
 */
function inspect(\YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $promise)
{
 ...
 *
 * This promise is rejected with a {@see ***REMOVED***} if the number of
 ...
 */
function is_fulfilled(\YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $promise)
{
 ...
 */
function is_rejected(\YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $promise)
{
 ...
 */
function is_settled(\YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $promise)
{
