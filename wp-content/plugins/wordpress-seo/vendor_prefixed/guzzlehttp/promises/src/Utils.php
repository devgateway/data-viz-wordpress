...
final class Utils
{
     ...
     *
     * This promise is rejected with a {@see ***REMOVED***} if the number
    ...
    public static function some($count, $promises)
    {
        ...
        return \YoastSEO_Vendor\GuzzleHttp\Promise\Each::of($promises, function ($value, $idx, \YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $p) use(&$results, $count) {
            ...
            if (\count($results) !== $count) {
                throw new \YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED***('Not enough promises to fulfill count', $rejections);
            }
            \ksort($results);
