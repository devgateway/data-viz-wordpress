...
class Uri implements \YoastSEO_Vendor\Psr\Http\Message\UriInterface
{
    ...
    private static $***REMOVED*** = 'a-zA-Z0-9_\\-\\.~';
    ...
    {
        return self::***REMOVED***($this->scheme, $this->getAuthority(), $this->path, $this->query, $this->fragment);
    }
    /**
     ...
     */
    public static function ***REMOVED***($scheme, $authority, $path, $query, $fragment)
    {
        $uri = '';
     ...
     * @return string
     *
     * @deprecated since version 1.4. Use UriResolver::***REMOVED*** instead.
     * @see UriResolver::***REMOVED***
     */
    public static function ***REMOVED***($path)
    {
        return \YoastSEO_Vendor\GuzzleHttp\Psr7\UriResolver::***REMOVED***($path);
    }
    /**
     ...
     * @return UriInterface
     */
    public static function ***REMOVED***(\YoastSEO_Vendor\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function ***REMOVED***(\YoastSEO_Vendor\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $result = self::getFilteredQueryString($uri, [$key]);
     ...
     * @return UriInterface
     */
    public static function ***REMOVED***(\YoastSEO_Vendor\Psr\Http\Message\UriInterface $uri, array $keyValueArray)
    {
    ...
    private function filterUserInfoComponent($component)
    {
        ...
        return \preg_replace_callback('/(?:[^%' . self::$***REMOVED*** . self::$charSubDelims . ']+|%(?![A-Fa-f0-9]{2}))/', [$this, 'rawurlencodeMatchZero'], $component);
    }
    /**
     * @param string $host
     *
     ...
     * @return string
     */
    private static function ***REMOVED***($key, $value)
    {
    ...
    private function filterPath($path)
    {
        ...
        return \preg_replace_callback('/(?:[^' . self::$***REMOVED*** . self::$charSubDelims . '%:@\\/]++|%(?![A-Fa-f0-9]{2}))/', [$this, 'rawurlencodeMatchZero'], $path);
    }
    /**
    ...
    private function filterQueryAndFragment($str)
    {
        ...
        return \preg_replace_callback('/(?:[^' . self::$***REMOVED*** . self::$charSubDelims . '%:@\\/\\?]++|%(?![A-Fa-f0-9]{2}))/', [$this, 'rawurlencodeMatchZero'], $str);
    }
