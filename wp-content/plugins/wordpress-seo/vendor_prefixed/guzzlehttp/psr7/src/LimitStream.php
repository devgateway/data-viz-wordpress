 ...
 * @final
 */
class LimitStream implements \YoastSEO_Vendor\Psr\Http\Message\***REMOVED***
{
    use ***REMOVED***;
     ...
     */
    public function __construct(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
