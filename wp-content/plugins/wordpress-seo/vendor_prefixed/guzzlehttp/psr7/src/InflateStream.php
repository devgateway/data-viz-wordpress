 ...
 * @final
 */
class InflateStream implements \YoastSEO_Vendor\Psr\Http\Message\***REMOVED***
{
    use ***REMOVED***;
    public function __construct(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream)
    {
        ...
        $***REMOVED*** = $this->getLengthOfPossibleFilenameHeader($stream, $header);
        // Skip the header, that is 10 + length of filename + 1 (nil) bytes
        $stream = new \YoastSEO_Vendor\GuzzleHttp\Psr7\LimitStream($stream, -1, 10 + $***REMOVED***);
    ...
    /**
     * @param ***REMOVED*** $stream
     * @param $header
     *
     * @return int
     */
    private function getLengthOfPossibleFilenameHeader(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream, $header)
    {
