...
final class Message
{
     ...
     * @return string
     */
    public static function toString(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message)
    {
     ...
     * @return string|null
     */
    public static function bodySummary(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message, $truncateAt = 120)
    {
     ...
     * @throws \***REMOVED***
     */
    public static function rewindBody(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message)
    {
        $body = $message->getBody();
        if ($body->tell()) {
            $body->rewind();
     ...
     * @return string
     */
    public static function ***REMOVED***($path, array $headers)
    {
