 ...
 */
function str(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message)
{
 ...
 */
function modify_request(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $changes)
{
 ...
 */
function rewind_body(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message)
{
 ...
 */
function copy_to_string(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream, $maxLen = -1)
{
 ...
 */
function copy_to_stream(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $source, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $dest, $maxLen = -1)
{
 ...
 */
function hash(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream, $algo, $rawOutput = \false)
{
 ...
 */
function readline(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream, $maxLength = null)
{
 ...
 * @internal
 *
 * @deprecated _parse_request_uri will be removed in guzzlehttp/psr7:2.0. Use Message::***REMOVED*** instead.
 */
function _parse_request_uri($path, array $headers)
{
    return \YoastSEO_Vendor\GuzzleHttp\Psr7\Message::***REMOVED***($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message, $truncateAt = 120)
{
 ...
 * @internal
 *
 * @deprecated _caseless_remove will be removed in guzzlehttp/psr7:2.0. Use Utils::***REMOVED*** instead.
 */
function _caseless_remove($keys, array $data)
{
    return \YoastSEO_Vendor\GuzzleHttp\Psr7\Utils::***REMOVED***($keys, $data);
}
