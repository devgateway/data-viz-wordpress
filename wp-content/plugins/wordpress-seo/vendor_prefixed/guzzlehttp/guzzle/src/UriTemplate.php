...
/**
 * Expands URI templates. Userland ***REMOVED*** of PECL uri_template.
 *
...
class UriTemplate
{
     ...
     */
    private function ***REMOVED***($expression)
    {
        $result = [];
    ...
    private function expandMatch(array $matches)
    {
        ...
        foreach ($parsed['values'] as $value) {
            ...
            if (\is_array($variable)) {
                ...
                if ($parsed['operator'] === '+' || $parsed['operator'] === '#') {
                    $expanded = $this->***REMOVED***($expanded);
                }
            }
            if ($***REMOVED***) {
                if (!$expanded && $joiner !== '&') {
     ...
     * @return string
     */
    private function ***REMOVED***($string)
    {
