...
class ***REMOVED***
{
     ...
     * @return ***REMOVED***
     */
    private function withTracking(\YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** $promise, $uri, $statusCode)
    {
        return $promise->then(function (\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $response) use($uri, $statusCode) {
     ...
     */
    private function guardMax(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array &$options)
    {
     ...
     * @return ***REMOVED***
     */
    public function modifyRequest(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $options, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $response)
    {
     ...
     * @return UriInterface
     */
    private static function redirectUri(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $response, array $protocols)
    {
