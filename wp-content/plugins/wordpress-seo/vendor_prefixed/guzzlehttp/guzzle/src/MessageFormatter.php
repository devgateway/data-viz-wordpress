...
class ***REMOVED***
{
     ...
     * @return string
     */
    public function format(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $response = null, \Exception $error = null)
    {
        $cache = [];
     ...
     * @return string
     */
    private function headers(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $message)
    {
        $result = '';
