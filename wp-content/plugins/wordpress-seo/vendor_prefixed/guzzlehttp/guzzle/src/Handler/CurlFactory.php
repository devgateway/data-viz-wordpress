...
class CurlFactory implements \YoastSEO_Vendor\GuzzleHttp\Handler\***REMOVED***
{
     ...
     *
     * @return \GuzzleHttp\Promise\***REMOVED***
     */
    public static function finish(callable $handler, \YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy, \YoastSEO_Vendor\GuzzleHttp\Handler\***REMOVED*** $factory)
    {
    ...
    private static function finishError(callable $handler, \YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy, \YoastSEO_Vendor\GuzzleHttp\Handler\***REMOVED*** $factory)
    {
    ...
    private static function ***REMOVED***(\YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy, array $ctx)
    {
        ...
        if ($easy->***REMOVED***) {
            return \YoastSEO_Vendor\GuzzleHttp\Promise\rejection_for(new \YoastSEO_Vendor\GuzzleHttp\Exception\***REMOVED***('An error was encountered during the on_headers event', $easy->request, $easy->response, $easy->***REMOVED***, $ctx));
        }
    ...
    private function ***REMOVED***(\YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy)
    {
    ...
    private function applyBody(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $options, array &$conf)
    {
    ...
    private function ***REMOVED***(\YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy, array &$conf)
    {
     ...
     */
    private static function ***REMOVED***(callable $handler, \YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy, array $ctx)
    {
        try {
    ...
    private function ***REMOVED***(\YoastSEO_Vendor\GuzzleHttp\Handler\EasyHandle $easy)
    {
        ...
        return function ($ch, $h) use($onHeaders, $easy, &$***REMOVED***) {
            $value = \trim($h);
            if ($value === '') {
                $***REMOVED*** = \true;
                $easy->***REMOVED***();
