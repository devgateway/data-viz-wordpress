...
class MockHandler implements \Countable
{
     ...
     * @return HandlerStack
     */
    public static function ***REMOVED***(array $queue = null, callable $onFulfilled = null, callable $onRejected = null)
    {
        return \YoastSEO_Vendor\GuzzleHttp\HandlerStack::create(new self($queue, $onFulfilled, $onRejected));
    }
    /**
     * The passed in value must be an array of
     * {@see Psr7\Http\Message\***REMOVED***} objects, Exceptions,
    ...
    public function append()
    {
        foreach (\func_get_args() as $value) {
            if ($value instanceof \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** || $value instanceof \Exception || $value instanceof \YoastSEO_Vendor\GuzzleHttp\Promise\***REMOVED*** || \is_callable($value)) {
                $this->queue[] = $value;
            } else {
    ...
    private function invokeStats(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $options, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $response = null, $reason = null)
    {
