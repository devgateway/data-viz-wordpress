...
class StreamHandler
{
    ...
    private function invokeStats(array $options, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, $startTime, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $response = null, $error = null)
    {
    ...
    private function ***REMOVED***(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $options, $stream, $startTime)
    {
        ...
        if (isset($options['on_headers'])) {
            try {
                ...
                $ex = new \YoastSEO_Vendor\GuzzleHttp\Exception\***REMOVED***($msg, $request, $response, $e);
    ...
    private function createSink(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $stream, array $options)
    {
        if (!empty($options['stream'])) {
            return $stream;
        }
        $sink = isset($options['sink']) ? $options['sink'] : \fopen('php://temp', 'r+');
        return \is_string($sink) ? new \YoastSEO_Vendor\GuzzleHttp\Psr7\***REMOVED***($sink, 'w+') : \YoastSEO_Vendor\GuzzleHttp\Psr7\stream_for($sink);
    }
     ...
     */
    private function drain(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $source, \YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $sink, $contentLength)
    {
    ...
    private function createStream(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $options)
    {
        ...
        $context = $this->***REMOVED***(function () use($context, $params) {
            return \stream_context_create($context, $params);
        });
        return $this->***REMOVED***(function () use($uri, &$http_response_header, $context, $options) {
    ...
    private function resolveHost(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, array $options)
    {
        $uri = $request->getUri();
    ...
    private function ***REMOVED***(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request)
    {
        $headers = '';
        ...
        $context = ['http' => ['method' => $request->getMethod(), 'header' => $headers, 'protocol_version' => $request->***REMOVED***(), 'ignore_errors' => \true, 'follow_location' => 0]];
    ...
    private function add_proxy(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, &$options, $value, &$params)
    {
        if (!\is_array($value)) {
    ...
    private function add_timeout(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, &$options, $value, &$params)
    {
        if ($value > 0) {
            $options['http']['timeout'] = $value;
        }
    }
    private function add_verify(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, &$options, $value, &$params)
    {
        if ($value === \true) {
    ...
    private function add_cert(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, &$options, $value, &$params)
    {
        if (\is_array($value)) {
    ...
    private function add_progress(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, &$options, $value, &$params)
    {
        $this->***REMOVED***($params, function ($code, $a, $b, $c, $transferred, $total) use($value) {
            if ($code == \STREAM_NOTIFY_PROGRESS) {
                $value($total, $transferred, null, null);
            }
        });
    }
    private function add_debug(\YoastSEO_Vendor\Psr\Http\Message\***REMOVED*** $request, &$options, $value, &$params)
    {
        if ($value === \false) {
            return;
        }
        ...
        $this->***REMOVED***($params, function () use($ident, $value, $map, $args) {
    ...
    private function ***REMOVED***(array &$params, callable $notify)
    {
