...
class ***REMOVED***
{
    ...
    {
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('authenticate'), ['methods' => 'POST', 'callback' => [$this, 'authenticate'], 'permission_callback' => [$this, '***REMOVED***']]);
        ...
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('timestamp'), ['methods' => 'POST', 'callback' => [$this, 'timestamp'], 'permission_callback' => [$this, '***REMOVED***']]);
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('timestamp.transaction.latest'), ['methods' => 'GET', 'callback' => [$this, 'showLatestTimestampTransaction'], 'permission_callback' => [$this, '***REMOVED***']]);
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('settings'), ['methods' => 'GET', 'callback' => [$this, 'settings'], 'permission_callback' => [$this, '***REMOVED***']]);
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('saveSettings'), ['methods' => 'POST', 'callback' => [$this, 'saveSettings'], 'permission_callback' => [$this, '***REMOVED***']]);
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('***REMOVED***'), ['methods' => 'GET', 'callback' => [$this, '***REMOVED***'], 'permission_callback' => [$this, '***REMOVED***']]);
        \register_rest_route(\YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::getNamespace(), \YoastSEO_Vendor\WordProof\SDK\Helpers\RestApiHelper::endpoint('***REMOVED***.destroy'), ['methods' => 'POST', 'callback' => [$this, 'destroyAuthentication'], 'permission_callback' => [$this, '***REMOVED***']]);
    }
    /**
    ...
    {
        $data = \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::get();
        $data->status = 200;
    ...
    public function saveSettings(\WP_REST_Request $request)
    {
        ...
        \YoastSEO_Vendor\WordProof\SDK\Helpers\OptionsHelper::set('settings', $***REMOVED***);
        $data = (object) [];
        $data->status = 200;
        return new \WP_REST_Response($data, $data->status);
    }
    ...
    {
        $data = (object) ['is_authenticated' => \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::***REMOVED***(), 'status' => 200];
        return new \WP_REST_Response($data, $data->status);
    }
    /**
    ...
    {
        \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::logout();
        return $this->***REMOVED***();
    }
    /**
    ...
    public function timestamp(\WP_REST_Request $request)
    {
        ...
        return \YoastSEO_Vendor\WordProof\SDK\Controllers\***REMOVED***::timestamp($postId);
    }
    /**
    ...
    public function showLatestTimestampTransaction(\WP_REST_Request $request)
    {
        $data = $request->get_params();
        $postId = \intval($data['id']);
        $transactions = \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::get($postId, '_wordproof_blockchain_transaction', \false);
    ...
    public function hashInput(\WP_REST_Request $request)
    {
        ...
        $hashInput = \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::get($postId, '_wordproof_hash_input_' . $hash);
    ...
    public function authenticate(\WP_REST_Request $request)
    {
        ...
        return \YoastSEO_Vendor\WordProof\SDK\Support\***REMOVED***::token($state, $code);
    }
    /**
        ...
        if (isset($response->type) && isset($response->data)) {
            switch ($response->type) {
                ...
                case 'dump_item':
                    ...
                    \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::update($response->data->uid, $key, \json_decode($response->data->hash_input));
    ...
    private function setBlockchainTransaction($response)
    {
        ...
        \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::add($postId, '_wordproof_blockchain_transaction', $blockchainTransaction);
        $schema = \YoastSEO_Vendor\WordProof\SDK\Helpers\SchemaHelper::getSchema($postId);
        \YoastSEO_Vendor\WordProof\SDK\Helpers\***REMOVED***::update($postId, '_wordproof_schema', $schema);
    }
    /**
