...
class Whip_VersionRequirement implements Whip_Requirement {
	...
	public function __construct( $component, $version, $operator = '=' ) {
		$this->***REMOVED***( $component, $version, $operator );
	 ...
	 * @param string $***REMOVED*** The comparison string for this version requirement.
	 *
	 ...
	 */
	public static function ***REMOVED***( $component, $***REMOVED*** ) {
		...
		if ( ! preg_match( $matcher, $***REMOVED***, $match ) ) {
			throw new Whip_InvalidVersionComparisonString( $***REMOVED*** );
		}
	 ...
	 */
	private function ***REMOVED***( $component, $version, $operator ) {
		if ( empty( $component ) ) {
		...
		$***REMOVED*** = array( '=', '==', '===', '<', '>', '<=', '>=' );
		if ( ! in_array( $operator, $***REMOVED***, true ) ) {
			throw new Whip_InvalidOperatorType( $operator, $***REMOVED*** );
		}
	}
}
