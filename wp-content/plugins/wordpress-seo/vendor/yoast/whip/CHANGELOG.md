...
The format is based on [Keep a Changelog](http://***REMOVED***.com/)
...
* The `Whip_InvalidOperatorType::__construct()` method now has a second, optional `$***REMOVED***` parameter. [#62]
