	...
	public function enqueue_assets() {
		...
		$this->admin_asset_manager->localize_script(
			...
			[
				...
				'shortlinks'               => [
					'***REMOVED***'         => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-orphaned-content' ),
					'***REMOVED***'      => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-cornerstone-content' ),
