...
class Indexables_Page_Action {
	...
	public function get_setup_info( $content_threshold, $analysis_threshold ) {
		$features = [
			'***REMOVED***'    => $this->options_helper->get( 'keyword_analysis_active', true ),
			'***REMOVED***' => $this->options_helper->get( 'content_analysis_active', true ),
			'***REMOVED***'   => $this->options_helper->get( 'enable_text_link_counter', true ),
		];
