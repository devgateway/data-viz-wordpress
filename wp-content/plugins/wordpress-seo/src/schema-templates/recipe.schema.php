...
{{schema name="yoast/recipe"}}
{
	...
	"***REMOVED***": {{inner-blocks allowed-blocks=[ "yoast/recipe-instructions" ] only-first=true }},
	"***REMOVED***": {{inner-blocks allowed-blocks=[ "yoast/recipe-ingredients" ] only-first=true }},
