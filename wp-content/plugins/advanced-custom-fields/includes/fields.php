...
function acf_get_pro_field_types() {
	return array(
		'clone'            => array(
			...
			'doc_url'       => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/clone/', 'docs', 'field-type-selection' ),
			...
			'tutorial_url'  => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/how-to-use-the-clone-field/', 'docs', 'field-type-selection' ),
			'category'      => 'layout',
			'pro'           => true,
		),
		'flexible_content' => array(
			...
			'doc_url'       => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/flexible-content/', 'docs', 'field-type-selection' ),
			...
			'tutorial_url'  => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/building-layouts-with-the-flexible-content-field-in-a-theme/', 'docs', 'field-type-selection' ),
			'category'      => 'layout',
			'pro'           => true,
		),
		'gallery'          => array(
			...
			'doc_url'       => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/gallery/', 'docs', 'field-type-selection' ),
			...
			'tutorial_url'  => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/how-to-use-the-gallery-field/', 'docs', 'field-type-selection' ),
			'category'      => 'content',
			'pro'           => true,
		),
		'repeater'         => array(
			...
			'doc_url'       => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/repeater/', 'docs', 'field-type-selection' ),
			...
			'tutorial_url'  => acf_add_url_utm_tags( 'https://www.***REMOVED***.com/resources/repeater/how-to-use-the-repeater-field/', 'docs', 'field-type-selection' ),
			'category'      => 'layout',
			'pro'           => true,
		),
	);
