<div class="acf-field-group-pro-features-wrapper">
	...
	<div class="acf-field-group-pro-features-actions">
		<a target="_blank" href="<?php echo acf_add_url_utm_tags( 'https://www.***REMOVED***.com/pro/', 'ACF upgrade', 'metabox' ); ?>" class="acf-btn acf-btn-upgrade"><?php _e( 'Upgrade Now', 'acf' ); ?><i class="acf-icon acf-icon-arrow-right"></i></a>
	</div>
