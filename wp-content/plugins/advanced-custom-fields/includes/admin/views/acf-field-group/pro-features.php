...
$acf_learn_more_link                = acf_add_url_utm_tags( 'https://www.***REMOVED***.com/pro/', 'ACF upgrade', 'metabox' );
$acf_learn_more_target              = '_blank';
$acf_pricing_text                   = __( 'View Pricing & Upgrade', 'acf' );
$acf_pricing_link                   = acf_add_url_utm_tags( 'https://www.***REMOVED***.com/pro/', 'ACF upgrade', 'metabox_pricing', 'pricing-table' );
	...
	<div class="acf-field-group-pro-features-wrapper">
		...
		<div class="acf-field-group-pro-features-content">
			...
			<div class="acf-field-group-pro-features-actions">
				<a target="<?php echo esc_attr( $acf_learn_more_target ); ?>" href="<?php echo $acf_learn_more_link; ?>" class="acf-btn acf-btn-muted acf-pro-features-learn-more"><?php //phpcs:ignore WordPress.Security.EscapeOutput.***REMOVED*** -- escaped on generation. ?>
					<?php echo esc_html( $acf_learn_more_text ); ?> <i class="acf-icon acf-icon-arrow-up-right"></i>
				</a>
				<a target="_blank" href="<?php echo $acf_pricing_link; ?>" class="acf-btn acf-pro-features-upgrade"><?php //phpcs:ignore WordPress.Security.EscapeOutput.***REMOVED*** -- escaped on generation. ?>
	...
	<div class="acf-field-group-pro-features-footer-wrap">
		<div class="acf-field-group-pro-features-footer">
			...
			<div class="acf-more-tools-from-wpengine">
				<a href="<?php echo $acf_more_tools_link; ?>" target="_blank"><?php esc_html_e( 'More Tools from WP Engine', 'acf' ); ?> <i class="acf-icon acf-icon-arrow-up-right"></i></a><?php //phpcs:ignore WordPress.Security.EscapeOutput.***REMOVED*** -- escaped on generation. ?>
			</div>
		</div>
	</div>
</div>
