...
$acf_learn_how_to_fix = '<a href="' . acf_add_url_utm_tags( 'https://www.***REMOVED***.com/escaping-the-field/', 'docs', '6-2-5-security-changes' ) . '" target="_blank">' . __( 'Learn&nbsp;more', 'acf' ) . '</a>';
