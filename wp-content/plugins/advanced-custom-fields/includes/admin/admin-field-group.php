...
if ( ! class_exists( 'acf_admin_field_group' ) ) {
	...
	class acf_admin_field_group {
		...
		public function save_post( $post_id, $post ) {
			...
			// delete fields.
			if ( $_POST['_acf_delete_fields'] ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.***REMOVED*** -- Sanitized below.

				// clean.
				$ids = explode( '|', $_POST['_acf_delete_fields'] ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.***REMOVED*** -- Sanitized below.
