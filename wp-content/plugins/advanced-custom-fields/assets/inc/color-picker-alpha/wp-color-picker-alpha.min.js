...
! ( function ( e, a ) {
	...
	if (
		...
		var t = parseInt( window.***REMOVED***.version, 10 );
		if ( ! isNaN( t ) && o.version <= t ) return;
	}
	Color.fn.***REMOVED***( 'to_s' ) ||
			...
			_getColor: function ( o ) {
				return (
					...
					this.alphaOptions.alphaEnabled
						? ( ( o = o.to_s( this.alphaOptions.***REMOVED*** ) ),
