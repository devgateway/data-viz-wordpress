	...
	( function ( a, b ) {
		...
		function z( b ) {
			...
			var c = 0,
				d = 0;
			if ( '***REMOVED***' in b )
				( c = b.***REMOVED*** ), ( d = b.selectionEnd - c );
		...
		function B( a ) {
			a.***REMOVED***(), a.stopImmediatePropagation();
		}
		function C( b ) {
			if ( ! g ) {
				var c =
					b[ 0 ].currentStyle ||
					window.***REMOVED***( b[ 0 ], null );
		...
		if ( window.Select2 === b ) {
			...
			( i = a( document ) ),
				...
				( c = O( Object, {
					...
					init: function ( c ) {
						...
						( this.opts = c = this.prepareOpts( c ) ),
							...
							this.container.addClass(
								K( c.***REMOVED***, this.opts.element )
							),
							( this.***REMOVED*** = this.opts.element.attr(
								'tabindex'
							) ),
							this.opts.element
								.data( 'select2', this )
						...
						c.on(
							...
							d !== b &&
								( this.***REMOVED*** &&
									( delete this.***REMOVED***,
									( this.***REMOVED*** = null ) ),
								( this.***REMOVED*** = new d( function (
									b
								) {
									a.each( b, e._sync );
								} ) ),
								this.***REMOVED***.observe( c.get( 0 ), {
									attributes: ! 0,
									subtree: ! 1,
								} ) );
					},
					...
					***REMOVED***: function () {
						if ( this.select ) {
							...
							if ( this.opts.***REMOVED*** !== b )
								return (
									( 'first' === this.opts.***REMOVED*** &&
										c ) ||
									( 'function' ==
										typeof this.opts.***REMOVED*** &&
										this.opts.***REMOVED***(
											this.select
										) )
								);
				...
				( d = O( c, {
					...
					***REMOVED***: function () {
						this.parent.***REMOVED***.apply( this, arguments ) &&
							this.focusser.prop(
								'disabled',
								! this.***REMOVED***()
							);
					...
					***REMOVED***: function () {
						return this.select && this.***REMOVED***() === b
							? b
							: this.parent.***REMOVED***.apply(
									this,
									arguments
							  );
					},
				...
				( e = O( c, {
					...
					***REMOVED***: function ( a, b ) {
					...
					onSortStart: function () {
						...
						this.search.width( 0 ), this.***REMOVED***.hide();
					},
					onSortEnd: function () {
						var b = [],
							c = this;
						this.***REMOVED***.show(),
							this.***REMOVED***.appendTo(
								this.***REMOVED***.parent()
							),
							this.resizeSearch(),
							this.selection
