			...
			return (
				...
				e.define(
					...
					function ( h, f ) {
						...
						return (
							...
							( r.prototype.***REMOVED*** = function ( e ) {
							...
							( r.prototype.template = function ( e, t ) {
								var n = this.options.get( '***REMOVED***' ),
					...
					function ( r, a, l ) {
						...
						return (
							( e.prototype.render = function ( e ) {
								var t = r(
									'<li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" ***REMOVED***="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></li>'
								);
								( this.$***REMOVED*** = t ),
									...
									this.$selection.on(
										...
										function ( e ) {
											if (
												...
												( r._keyUpPrevented = e.***REMOVED***() ),
												e.which === l.BACKSPACE &&
													'' === r.$search.val() )
											) {
												var t = r.$***REMOVED***.prev(
													'.select2-selection__choice'
												);
												if ( 0 < t.length ) {
													var n = a.GetData(
				...
				e.define( 'select2/data/base', [ '../utils' ], function ( r ) {
					...
					return (
						...
						( n.prototype.***REMOVED*** = function ( e, t ) {
							var n = e.id + '-result-';
							return (
								( n += r.generateChars( 4 ) ),
								null != t.id
				...
				e.define(
					...
					function ( e, t, o ) {
						...
						return (
							...
							( n.prototype.***REMOVED*** = function ( e ) {
								return e;
							} ),
				...
				e.define( 'select2/data/***REMOVED***', [], function () {
					function e( e, t, n ) {
						( this.***REMOVED*** = n.get(
							'***REMOVED***'
						) ),
					...
					function ( o, e ) {
						...
						return (
							( t.prototype.render = function ( e ) {
								var t = e.call( this ),
									n = o(
										'<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" ***REMOVED***="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>'
									);
								return (
									( this.$***REMOVED*** = n ),
				...
				e.define( 'select2/dropdown/***REMOVED***', [], function () {
					function e( e, t, n, r ) {
						( this.placeholder = this.***REMOVED***(
							n.get( 'placeholder' )
						) ),
					...
					return (
						( e.prototype.append = function ( e, t ) {
							( t.results = this.***REMOVED***( t.results ) ),
								e.call( this, t );
						} ),
						( e.prototype.***REMOVED*** = function ( e, t ) {
							return (
								'string' == typeof t &&
									( t = { id: '', text: t } ),
								t
