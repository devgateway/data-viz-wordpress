...
( function ( factory ) {
	...
	var S2 = ( function () {
		...
		S2.define( 'select2/dropdown/***REMOVED***', [], function () {
			...
			***REMOVED***.prototype.position = function (
				decorated,
				$dropdown,
				$container
			) {
		...
		S2.define( 'select2/selection/***REMOVED***', [], function () {
			function ***REMOVED***() {}
