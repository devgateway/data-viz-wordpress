...
(function ($, undefined) {
  ...
  var ***REMOVED*** = function (v1, v2) {
    if (v2 instanceof Array) {
      return v2.length === 1 && ***REMOVED***(v1, v2[0]);
    }
  ...
  const ***REMOVED*** = function (field, type) {
    ...
    const ***REMOVED*** = function (results) {
    ...
    $select.data('***REMOVED***', select2Props);
    return $select;
  };
  /**
  ...
  var HasPageLink = acf.Condition.extend({
    ...
    choices: function (fieldObject) {
      return ***REMOVED***(fieldObject, 'page_link');
    }
  });
   ...
   *  @since 6.3
   */
  var ***REMOVED*** = acf.Condition.extend({
    type: '***REMOVED***',
    operator: '!==',
  ...
  var HasUser = acf.Condition.extend({
    ...
    choices: function (fieldObject) {
      return ***REMOVED***(fieldObject, 'user');
    }
  });
  ...
  var ***REMOVED*** = acf.Condition.extend({
    ...
    choices: function (fieldObject) {
      return ***REMOVED***(fieldObject, 'relationship');
    }
  });
  acf.registerConditionType(***REMOVED***);
  ...
  var HasPostObject = acf.Condition.extend({
    ...
    choices: function (fieldObject) {
      return ***REMOVED***(fieldObject, 'post_object');
    }
  });
  ...
  var HasTerm = acf.Condition.extend({
    ...
    choices: function (fieldObject) {
      return ***REMOVED***(fieldObject, 'taxonomy');
    }
  });
...
(function ($, undefined) {
  ...
  var Field = acf.Field.extend({
    ...
    initialize: function () {
      ...
      // add icon
      $label.prepend(***REMOVED***.iconHtml({
        open: this.get('open')
      }));
...
(function ($, undefined) {
  const Field = acf.Field.extend({
    ...
    events: {
      ...
      'click .acf-icon-picker-dashicon': '***REMOVED***',
      'focus .acf-icon-picker-dashicon-radio': '***REMOVED***',
      'blur .acf-icon-picker-dashicon-radio': '***REMOVED***',
      'keydown .acf-icon-picker-dashicon-radio': '***REMOVED***',
      'input .acf-dashicons-search-input': '***REMOVED***',
    ...
    addActions() {
      ...
      acf.addAction(this.get('name') + '/type_and_value_change', ***REMOVED*** => {
        // Align the visual state of each tab to the current value.
        this.alignDashiconsTabToCurrentValue(***REMOVED***);
        this.alignMediaLibraryTabToCurrentValue(***REMOVED***);
        this.alignUrlTabToCurrentValue(***REMOVED***);
      });
    },
    ***REMOVED***(type, value) {
      const typeAndValue = {
    ...
    initializeSelectedDashicon(typeAndValue) {
      ...
      this.***REMOVED***(typeAndValue.value, false).then(() => {
    ...
    ***REMOVED***() {
      ...
      dashicons.forEach(dashicon => {
        this.$dashiconsList().append(this.***REMOVED***(dashicon));
      });
    },
    ***REMOVED***() {
      const ***REMOVED*** = acf.get('***REMOVED***') || [];
      const dashicons = Object.entries(***REMOVED***).map(([key, value]) => {
        return {
          key,
          label: value
        };
    ...
    ***REMOVED***(searchTerm) {
      const ***REMOVED*** = searchTerm.toLowerCase();
      const dashicons = this.***REMOVED***();
      const ***REMOVED*** = dashicons.filter(function (icon) {
        const ***REMOVED*** = icon.label.toLowerCase();
        return ***REMOVED***.indexOf(***REMOVED***) > -1;
      });
      return ***REMOVED***;
    },
    ***REMOVED***(dashicon, setFocus = true) {
      this.set('***REMOVED***', dashicon);
      ...
      this.***REMOVED***('dashicons', dashicon);
      return thePromise;
    },
    ***REMOVED***() {
    ...
    ***REMOVED***(e) {
      ...
      if (this.get('***REMOVED***') !== dashicon) {
        this.***REMOVED***();
        this.***REMOVED***(dashicon);
      }
    },
    ***REMOVED***(e) {
    ...
    ***REMOVED***(e) {
      ...
      // By forcing focus on the input, we fire ***REMOVED***.
      $newIcon.find('input').prop('checked', true).trigger('focus');
    },
    ***REMOVED***(e) {
      const searchTerm = e.target.value;
      const ***REMOVED*** = this.***REMOVED***(searchTerm);
      if (***REMOVED***.length > 0 || !searchTerm) {
        this.set('dashicons', ***REMOVED***);
        ...
        const ***REMOVED*** = searchTerm.length > 30 ? searchTerm.substring(0, 30) + '&hellip;' : searchTerm;
        this.$('.acf-dashicons-list ').hide();
        this.$('.acf-dashicons-list-empty').find('.acf-invalid-dashicon-search-term').text(***REMOVED***);
    ...
    ***REMOVED***(e) {
    ...
    async onMediaLibraryButtonClick(e) {
      ...
      await this.selectAndReturnAttachment().then(attachment => {
        ...
        this.***REMOVED***('media_library', attachment.id);
      });
    },
...
(function ($, undefined) {
  var Field = acf.Field.extend({
    ...
    events: {
      ...
      'keypress .choices-list .acf-rel-item': '***REMOVED***',
      'keypress .values-list .acf-rel-item': '***REMOVED***',
      'click [data-name="remove_item"]': 'onClickRemove',
      'touchstart .values-list .acf-rel-item': '***REMOVED***'
    },
    $control: function () {
...
(function ($, undefined) {
  ...
  var Select2_4 = Select2.extend({
    initialize: function () {
      ...
      // Clear empty ***REMOVED***, ***REMOVED***, or ***REMOVED***.
      if (!options.***REMOVED***) {
      ...
      if (!acf.isset(window, 'jQuery', 'fn', 'selectWoo')) {
        if (!options.***REMOVED***) {
          options.***REMOVED*** = function (selection) {
    ...
    ***REMOVED***: function () {
      ...
      editor.savePost = function (options) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          if ('undefined' !== typeof acf.***REMOVED***) {
            const ***REMOVED*** = wp.data.select('core/block-editor').getSelectedBlockClientId();
            if (***REMOVED*** && ***REMOVED*** in acf.***REMOVED***) {
              const acfBlockState = acf.***REMOVED***[***REMOVED***];
              if (acfBlockState.validation_errors) {
                ...
                notices.***REMOVED***(acf.__('An ACF Block on this page requires attention before you can save.'), {
                  id: 'acf-validation',
                  isDismissible: true
                });
                wp.data.dispatch('core/editor').***REMOVED***('acf/block/' + ***REMOVED***);
