...
(function ($, undefined) {
  ...
  */
  ...
  acf.isInView = function (el) {
    ...
    return rect.top !== rect.bottom && rect.top >= 0 && rect.left >= 0 && rect.bottom <= (window.innerHeight || document.***REMOVED***.clientHeight) && rect.right <= (window.innerWidth || document.***REMOVED***.clientWidth);
  };
  ...
  $(window).on('load', function () {
    // Use timeout to ensure action runs after Gutenberg has modified DOM elements during "***REMOVED***".
    setTimeout(function () {
      acf.doAction('load');
    });
  });
