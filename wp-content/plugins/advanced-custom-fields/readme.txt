...
Contributors: ***REMOVED***, wpengine, elliotcondon, mattshaw, lgladdy, antpb, mindctrl, modernnerd, rfmeier, andrewbotz
...
= Links =
* [Website](https://***REMOVED***.com/?utm_source=wordpress.org&utm_medium=free%20plugin%20listing&utm_campaign=ACF%20Website)
* [Documentation](https://***REMOVED***.com/resources/?utm_source=wordpress.org&utm_medium=free%20plugin%20listing&utm_campaign=ACF%20Website)
* [Support](https://support.***REMOVED***.com)
* [ACF PRO](https://***REMOVED***.com/pro/?utm_source=wordpress.org&utm_medium=free%20plugin%20listing&utm_campaign=ACF%20Pro%20Upgrade)
...
[Upgrade to Pro](https://***REMOVED***.com/pro/?utm_source=wordpress.org&utm_medium=free%20plugin%20listing&utm_campaign=ACF%20Pro%20Upgrade)
...
5. **Read** the documentation to [get started](https://***REMOVED***.com/resources/getting-started-with-acf/?utm_source=wordpress.org&utm_medium=free%20plugin%20listing&utm_campaign=ACF%20Website)
...
* [View Release Post](https://www.***REMOVED***.com/blog/acf-6-0-***REMOVED***improvement/)
* New - Flexible Content field now has a new admin user experience when editing layouts
* New - Tabs for field settings in the field group editor can now be disabled via a new “Field Settings Tabs” screen option or with the new [`acf/field_group/disable_field_settings_tabs`](https://www.***REMOVED***.com/resources/acf-field_group-disable_field_settings_tabs) filter
...
* Improvement - JavaScript ***REMOVED*** performance while editing large field groups has been improved, especially in Safari
...
* Security Fix - ACF shortcode security fixes detailed [here](https://www.***REMOVED***.com/blog/acf-6-0-3-release-security-changes-to-the-acf-shortcode-and-ui-improvements/#acf-shortcode)
...
* New - ACF now has a new refreshed UI with improved UX for editing field groups, including a new tabbed settings layout for fields. Third party ACF extension plugin developers can read more about the optional changes they can make to support the new tabs in [our release announcement post](https://www.***REMOVED***.com/blog/acf-6-0-released/#new-ui)
* New - Repeaters now have an optional "Pagination" setting which can be used to control the number of rows displayed at once. More details can be found on our [Repeater field documentation](https://www.***REMOVED***.com/resources/repeater/#pagination)
* New - ACF Blocks now have a versioning system allowing developers to opt in to new features
* New - ACF Blocks now support version 2, enabling block.json support, reduced wrapper markup and significant other new features. Full details and examples of this can be found in [What's new with ACF Blocks in ACF 6](https://www.***REMOVED***.com/resources/whats-new-with-acf-blocks-in-acf-6/)
* New - ACF Blocks no longer use Block IDs saved in the block comment. See [What's new with ACF Blocks in ACF 6](https://www.***REMOVED***.com/resources/whats-new-with-acf-blocks-in-acf-6/#block-id) for more information.
...
* Security Fix - ACF shortcode security fixes from the ACF 6.0.3 release. See the [6.0.3 release post](https://www.***REMOVED***.com/blog/acf-6-0-3-release-security-changes-to-the-acf-shortcode-and-ui-improvements/#acf-shortcode) for more information
...
* Fix - Default values and the `acf/load_value` filter are now applied if a field value load [fails security validation](https://www.***REMOVED***.com/resources/acf-field-functions/#non-acf-data)
...
* Fix - ACF now validates access to option page field values when accessing via field keys the same way as field names. [View More](https://www.***REMOVED***.com/resources/acf-field-functions/#non-acf-data)
...
* [View Release Post](https://www.***REMOVED***.com/blog/acf-5-12-released/)
...
* Fix - Previously implemented data access changes for get_field() and the_field() are now limited to the ACF shortcode only. [Learn more](https://www.***REMOVED***.com/resources/acf-field-functions/)
...
* Fix - Added warning for when get_field() or similar functions are called before ACF has initialized. [Learn more](https://www.***REMOVED***.com/resources/acf-field-functions/)
...
* [View Release Post](https://www.***REMOVED***.com/blog/acf-5-11-release-rest-api/)
...
* [View Release Post](https://www.***REMOVED***.com/blog/acf-5-10-release-html-escaping-blocks-api-v2-block-preloading-and-more/)
