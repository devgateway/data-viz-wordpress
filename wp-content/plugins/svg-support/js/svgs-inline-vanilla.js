...
document.***REMOVED***("***REMOVED***", function(event) {
    ...
    function ***REMOVED***(img) {
        ...
        // Open the ***REMOVED*** with GET method
    ...
    (bodhisvgsInlineSupport = function() {
        ...
        if (***REMOVED*** === 'true') {
            ...
            var allImages = document.***REMOVED***('img'); // Find all images on page
		...
		var target;
		if (***REMOVED*** === 'true') {
			target = (typeof cssTarget.Bodhi === 'string' ? cssTarget.***REMOVED*** : 'style-svg');
		} else {
        ...
        for (var i = 0; i < allImages.length; i++) {
            ...
            if (typeof allImages[i].src === 'undefined') { // not an image
                ...
                ***REMOVED***(allImages[i]); // Iterate through child nodes
