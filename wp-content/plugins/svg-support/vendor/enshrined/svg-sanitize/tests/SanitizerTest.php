...
use enshrined\svgSanitize\Tests\Fixtures\***REMOVED***;
...
class SanitizerTest extends TestCase
{
    ...
    {
        $sanitizer = new Sanitizer();
        $sanitizer->***REMOVED***(new ***REMOVED***());
        $tags = $sanitizer->***REMOVED***();

        self::assertSame('array', gettype($tags));
        self::assertSame(array_map('strtolower', ***REMOVED***::getTags()), $tags);
    }
    ...
    {
        $sanitizer = new Sanitizer();
        $sanitizer->***REMOVED***(new TestAllowedAttributes());
        $attributes = $sanitizer->***REMOVED***();
    ...
    public function testSanitizeAndMinifiySVGDoc()
    {
        $dataDirectory = __DIR__ . '/data';
        $initialData = file_get_contents($dataDirectory . '/svgTestOne.svg');
        $expected = file_get_contents($dataDirectory . '/***REMOVED***.svg');
    ...
    {
        $dataDirectory = __DIR__ . '/data';
        $initialData = file_get_contents($dataDirectory . '/***REMOVED***.svg');
        $expected = file_get_contents($dataDirectory . '/***REMOVED***.svg');
