...
You may pass your own whitelist of tags and attributes by using the `Sanitizer::***REMOVED***` and `Sanitizer::***REMOVED***` methods respectively.

These methods require that you implement the `enshrined\svgSanitize\data\TagInterface` or `enshrined\svgSanitize\data\***REMOVED***`.
