...
require_once( __DIR__ . '/data/***REMOVED***.php' );
require_once( __DIR__ . '/data/TagInterface.php' );
require_once( __DIR__ . '/data/***REMOVED***.php' );
require_once( __DIR__ . '/data/AllowedTags.php' );
require_once( __DIR__ . '/data/XPath.php' );
require_once( __DIR__ . '/***REMOVED***/Resolver.php' );
require_once( __DIR__ . '/***REMOVED***/Subject.php' );
require_once( __DIR__ . '/***REMOVED***/Usage.php' );
require_once( __DIR__ . '/Exceptions/***REMOVED***.php' );
