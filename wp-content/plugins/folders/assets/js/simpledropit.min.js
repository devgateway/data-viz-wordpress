...
(function (global, factory) {
        ...
        _extends = Object.assign || function (target) {
            for (var i = 1; i < arguments.length; i++) {
                ...
                for (var key in source) {
                    if (Object.prototype.***REMOVED***.call(source, key)) {
    ...
    function _assertThisInitialized(self) {
        if (self === void 0) {
            throw new ***REMOVED***("this hasn't been initialised - super() hasn't been called");
        }
    ...
    var ***REMOVED*** = /*#__PURE__*/function () {
        ...
        ***REMOVED***.isFiles = function isFiles(arg) {
            var r = false;
    ...
    var SimpleDropit = /*#__PURE__*/function (_SimpleDropitMethods) {
        ...
        function SimpleDropit(selector, options) {
            ...
            _this.options = _extends({}, SimpleDropit.***REMOVED***, options);
            _this.classNames = _extends({}, SimpleDropit.***REMOVED***.classNames, _this.options.classNames);
        ...
        _proto.initDom = function initDom() {
            ...
            if (this.el.closest('.' + this.classNames.boxEl) !== null) {
                ...
                this.***REMOVED*** = this.boxEl.querySelector('.' + this.classNames.***REMOVED***);
                this.***REMOVED*** = this.boxEl.querySelector('.' + this.classNames.***REMOVED***);
                ...
                this.***REMOVED*** = document.createElement('div');
                ...
                this.***REMOVED***.classList.add(this.classNames.***REMOVED***);
                this.***REMOVED***.classList.add(this.classNames.***REMOVED***);
                ...
                this.***REMOVED***.innerHTML = this.options.***REMOVED*** + '&nbsp;';
                this.***REMOVED***.appendChild(this.***REMOVED***);
                this.***REMOVED***.appendChild(this.filenameEl);
                ...
                this.***REMOVED***.appendChild(this.browseLabelEl);
                this.***REMOVED***.appendChild(elClone);
                this.boxWrapperEl.appendChild(this.***REMOVED***);
        ...
        _proto.initListeners = function initListeners() {
            ...
            ['drag', 'dragstart', 'dragend', 'dragover', 'dragenter', 'dragleave', 'drop'].forEach(function (e) {
                ***REMOVED***(_this2.boxEl).***REMOVED***(e, _this2.preventEventPropagation, false);

                _this2.boxEl.***REMOVED***(e, _this2.preventEventPropagation, false);
            });
            ['dragenter', 'dragover'].forEach(function (e) {
                ***REMOVED***(_this2.boxEl).***REMOVED***(e, _this2.dragIn, true);
            });
            ['dragleave', 'drop'].forEach(function (e) {
                ***REMOVED***(_this2.boxEl).***REMOVED***(e, _this2.dragOut, true);
            });
            this.boxEl.***REMOVED***('drop', this.drop, true);
            this.el.***REMOVED***('change', this.onChange, true);
            this.browseLabelEl.***REMOVED***('click', function (event) {
