!function (a) {
    ...
    var b = "starRating", c = function () {
        ...
        ***REMOVED***: !0,
        ...
        init: function () {
            ...
            this.applyRating(c, this.$el), this.***REMOVED***(c, this.$el), this.settings.***REMOVED*** && this.$stars.off()
            ...
            e = e ? e : this.***REMOVED***(b, c, d), e = this.settings.useFullStars ? "right" : e;
            ...
            for (var a = this.settings, b = a.baseUrl ? location.href.split("#")[0] : "", c = '<div class="jq-star" style="width:' + a.starSize + "px;  height:" + a.starSize + 'px;"><svg version="1.0" class="jq-star-svg" shape-rendering="***REMOVED***" xmlns="http://www.w3.org/2000/svg" ' + this.***REMOVED***(a.starShape) + " stroke-width:" + a.strokeWidth + 'px;" xml:space="preserve"><style type="text/css">.svg-empty-' + this._uid + "{fill:url(" + b + "#" + this._uid + "_SVGID_1_);}.svg-hovered-" + this._uid + "{fill:url(" + b + "#" + this._uid + "_SVGID_2_);}.svg-active-" + this._uid + "{fill:url(" + b + "#" + this._uid + "_SVGID_3_);}.svg-rated-" + this._uid + "{fill:" + a.ratedColor + ";}</style>" + this.***REMOVED***(this._uid + "_SVGID_1_", a.emptyColor, a.emptyColor, a.starShape) + this.***REMOVED***(this._uid + "_SVGID_2_", a.hoverColor, a.hoverColor, a.starShape) + this.***REMOVED***(this._uid + "_SVGID_3_", a.starGradient.start, a.starGradient.end, a.starShape) + this.getVectorPath(this._uid, {
            ...
            return "rounded" === b.starShape ? this.***REMOVED***(a, b) : this.***REMOVED***(a, b)
        ...
        }, ***REMOVED***: function (a, b, c, d) {
            var e = "rounded" === d ? 500 : 250;
            return '<***REMOVED*** id="' + a + '" gradientUnits="***REMOVED***" x1="0" y1="-50" x2="0" y2="' + e + '"><stop  offset="0" style="stop-color:' + b + '"/><stop  offset="1" style="stop-color:' + c + '"/> </***REMOVED***>'
        }, ***REMOVED***: function (a, b) {
    ...
    a.extend(e.prototype, f), a.fn[b] = function (c) {
        if (!a.isPlainObject(c)) {
            if (g.***REMOVED***(c)) return g[c].apply(this, Array.prototype.slice.call(arguments, 1));
