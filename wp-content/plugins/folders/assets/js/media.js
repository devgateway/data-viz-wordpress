...
jQuery(document).on("click", ".media-frame-router .media-menu-item", function(){
    setTimeout(function(){
        if(***REMOVED***.length > 0) {
            if(jQuery(".folder_for_media option").length != (***REMOVED***.length+2)) {
                ...
                for (i = 0; i < ***REMOVED***.length; i++) {
                    selectedDD.append("<option value='" + ***REMOVED***[i].term_id + "'>"+***REMOVED***[i].name+"</option>");
                }
            ...
            if(jQuery("#media-attachment-taxonomy-filter").length) {
                ...
                if(!jQuery("#wcp-content").length) {
                    if(jQuery(".editor-post-featured-image").length) {
                        jQuery(".attachment-filters").val(***REMOVED***).trigger("change");
                    }
                }
            }
        },100);
        ...
        init: function () {
            if (this.uploader) {
                this.uploader.bind('FileFiltered', function (up, file) {
                    ***REMOVED***.push(selectedFolderMediaId);
                    filesInQueue++;
                ...
                this.uploader.bind('BeforeUpload', function (uploader, file) {
                    ...
                    folder_id = parseInt(***REMOVED***[***REMOVED***]);
                    if (folder_id > 0) {
                    ...
                    ***REMOVED***++;
                    jQuery("#current_upload_files").text(***REMOVED***);
                });
                ...
                this.uploader.bind('***REMOVED***', function (up, file) {
