...
<div class="folder-popup" id="folder-intro-popup">
    <div class="folder-popup-box">
        ...
        <div class="folder-popup-content">
            <?php printf(esc_html__("Select the places where you want Folders to appear (Media Library, Posts, Pages, Custom Posts). Need help? Visit our %s", "folders"), '<a target="_blank" href="https://premio.io/help/folders/?utm_soruce=***REMOVED***">'.esc_html__("Help Center", "folders")."</a>.") ?>
