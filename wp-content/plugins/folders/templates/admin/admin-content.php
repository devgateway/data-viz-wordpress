                ...
                <form action="" method="post" id="save-folder-form">
                    ...
                    <div class="folder-form-buttons hide-it pro-message" id="pro-notice">
                        ...
                        <div class="pro-notice">
                            <?php printf(esc_html__("%sUpgrade to Pro%s to create subfolders (with 20+ amazing features) & premium support 🎉", "folders"), '<a class="inline-button" target="_blank" href="'.esc_url($this->***REMOVED***()).'">', "</a>"); ?>
                        </div>
                    </div>
