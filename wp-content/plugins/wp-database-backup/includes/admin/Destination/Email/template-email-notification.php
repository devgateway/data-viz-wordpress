...
<div align="center" style="font-family:Arial;width:600px;background-color:#ffffff;margin:0 auto;padding:0px">
   ...
   ' . esc_html__('Database Backup Created Successfully on','wpdbbkp')  . esc_url($site_url) . '.
    ...
    <br><br>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" style="font-family:Arial;width:100%;border-collapse:collapse;border-spacing:0;margin:0px;padding:0px">
                <tbody><tr style="font-family:Arial;margin:0px;padding:0px">
                    ...
                    <td style="font-family:Arial;margin:0px;padding:2px 5px;border:1px solid #007bad">' . esc_html(***REMOVED***::wp_db_backup_format_bytes( $filesze )) . '</td>
    ...
    <br>
      '.esc_html__('If you like','wpdbbkp').' <b> '.esc_html__('WP Database Backup','wpdbbkp').'</b> '.esc_html__('please leave us a','wpdbbkp').' <a href="'.esc_url('http://wordpress.org/support/view/plugin-reviews/wp-database-backup').'" title="'.esc_attr__('Rating','wpdbbkp').'" target="_blank" data-***REMOVED***="'.esc_url('https://www.google.com/url?hl=en&amp;q=http://wordpress.org/support/view/plugin-reviews/wp-database-backup&amp;source=gmail&amp;ust=***REMOVED***&amp;usg=AFQjCNHxdc3F079wMTbRqbs8hw7tYkR6ww').'">'.esc_html__('rating','wpdbbkp').' </a>
      '.esc_html__('on','wpdbbkp').'  <a href="'.esc_url('http://wordpress.org/support/view/plugin-reviews/wp-database-backup').'" title="'.esc_attr__('Rating','wpdbbkp').'" target="_blank" data-***REMOVED***="'.esc_url('https://www.google.com/url?hl=en&amp;q=http://wordpress.org/support/view/plugin-reviews/wp-database-backup&amp;source=gmail&amp;ust=***REMOVED***&amp;usg=AFQjCNHxdc3F079wMTbRqbs8hw7tYkR6ww').'">'.esc_html__('WordPress.org','wpdbbkp').' </a>
