...
abstract class PKCS8 extends Progenitor
{
     ...
     * @return string
     */
    public static function ***REMOVED***(BigInteger $prime, BigInteger $base, BigInteger $privateKey, BigInteger $publicKey, $password = '', array $options = [])
    {
        $params = [
            'prime' => $prime,
            'base' => $base
