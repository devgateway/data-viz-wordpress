...
abstract class PuTTY extends Progenitor
{
     ...
     * @return string
     */
    public static function ***REMOVED***(BigInteger $p, BigInteger $q, BigInteger $g, BigInteger $y, BigInteger $x, $password = false, array $options = [])
    {
        if ($q->getLength() != 160) {
        ...
        return self::***REMOVED***($public, $private, 'ssh-dss', $password, $options);
    }
