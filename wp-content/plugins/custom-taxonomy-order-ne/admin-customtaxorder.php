...
function customtaxorder_menu() {
	...
	add_menu_page(esc_html__('Term Order', 'custom-taxonomy-order-ne'), esc_html__('Term Order', 'custom-taxonomy-order-ne'), $custom_cap, '***REMOVED***', 'customtaxorder_subpage', 'dashicons-list-view', 122);
...
function customtaxorder_links( $links, $file ) {
	if ( $file == plugin_basename( dirname(__FILE__).'/***REMOVED***.php' ) ) {
