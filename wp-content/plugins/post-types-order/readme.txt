...
= 1.3.8 = 
 ...
 - Multiple Improvments (thanks for support Video Geek - ***REMOVED***.com)
...
= 1.0.9 =
 - Admin will set the roles which can use the plugins (thanks for support Nick - ***REMOVED***.com)
