 ...
 * 2. The `postMessage` and `***REMOVED***` functions can be bound arbitrarily,
 ...
 *    strings. I actually prefer this structure anyway. `***REMOVED***` does
 *    not implement a corresponding ***REMOVED*** step, and as such it seems
...
function NoJQueryPostMessageMixin(postBinding, ***REMOVED***) {

    var ***REMOVED***, ***REMOVED***, ***REMOVED***,
  ...
  if (window.postMessage) {
    ...
    if (window.***REMOVED***) {
      ***REMOVED*** = function(callback) {
        window.***REMOVED***('message', callback, false);
      }
    ...
    this[***REMOVED***] = function(callback, sourceOrigin, delay) {
