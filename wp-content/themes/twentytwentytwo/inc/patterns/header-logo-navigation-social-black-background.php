 ...
 */
return array(
	'title'      => __( 'Logo, navigation, and social links header with black background', '***REMOVED***' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"padding":{"top":"var(--wp--custom--spacing--small, 1.25rem)","bottom":"var(--wp--custom--spacing--small, 1.25rem)"}}},"***REMOVED***":"foreground","textColor":"background","layout":{"inherit":true}} -->
					...
					<!-- wp:social-links {"iconColor":"background","***REMOVED***":"var(--wp--preset--color--background)","className":"is-style-logos-only"} -->
