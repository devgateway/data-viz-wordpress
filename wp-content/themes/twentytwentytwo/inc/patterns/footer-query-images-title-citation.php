 ...
 */
return array(
	'title'      => __( 'Footer with query, featured images, title, and citation', '***REMOVED***' ),
	'categories' => array( 'footer' ),
	'blockTypes' => array( 'core/template-part/footer' ),
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"***REMOVED***":"foreground","textColor":"background","layout":{"inherit":true}} -->
					...
					<!-- wp:group {"layout":{"type":"flex","***REMOVED***":"right"}} -->
