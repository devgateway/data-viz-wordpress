 ...
 */
return array(
	'title'      => __( 'Small header with dark background', '***REMOVED***' ),
	'categories' => array( 'header' ),
	'blockTypes' => array( 'core/template-part/header' ),
	'content'    => '<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"padding":{"top":"0px","bottom":"0px"}}},"***REMOVED***":"foreground","textColor":"background","layout":{"inherit":true}} -->
					...
					<!-- wp:image {"align":"wide","width":2000,"height":474,"sizeSlug":"full","***REMOVED***":"none"} -->
