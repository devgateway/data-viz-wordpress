...
while ( have_posts() ) :
	...
	$twentytwentyone_next_label = sprintf( esc_html__( 'Next %s', '***REMOVED***' ), $twentytwentyone_post_type_name );
	/* translators: %s: The post-type singlular name (example: Post, Page etc) */
	$twentytwentyone_previous_label = sprintf( esc_html__( 'Previous %s', '***REMOVED***' ), $twentytwentyone_post_type_name );
