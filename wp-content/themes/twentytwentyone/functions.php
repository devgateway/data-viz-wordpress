	...
	function twenty_twenty_one_setup() {
		...
		register_nav_menus(
			array(
				...
				'footer'  => __( 'Secondary menu', '***REMOVED***' ),
			)
		);
...
function twentytwentyone_block_editor_script() {
	...
	wp_enqueue_script( '***REMOVED***-editor', get_theme_file_uri( '/assets/js/editor.js' ), array( 'wp-blocks', 'wp-dom' ), wp_get_theme()->get( 'Version' ), true );
}
