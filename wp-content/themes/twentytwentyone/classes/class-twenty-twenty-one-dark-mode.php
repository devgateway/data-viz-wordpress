...
class Twenty_Twenty_One_Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_theme_file_path( 'classes/class-twenty-twenty-one-customize-notice-control.php' ); // phpcs:ignore WPThemeReview.***REMOVED***.FileInclude.***REMOVED***
		...
		$description .= sprintf(
			...
			__( 'https://wordpress.org/support/article/twenty-twenty-one/', '***REMOVED***' )
		);
		$description .= '</p>';
		$description .= '<p>' . __( 'Dark Mode can also be turned on and off with a button that you can find in the bottom right corner of the page.', '***REMOVED***' ) . '</p>';
