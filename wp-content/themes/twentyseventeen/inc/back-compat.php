...
function twentyseventeen_upgrade_notice() {
	...
	$message = sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', '***REMOVED***' ), $GLOBALS['wp_version'] );
...
function twentyseventeen_customize() {
	wp_die(
		/* translators: %s: The current WordPress version. */
		sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', '***REMOVED***' ), $GLOBALS['wp_version'] ),
		'',
		array(
			'back_link' => true,
		)
...
function twentyseventeen_preview() {
	if ( isset( $_GET['preview'] ) ) {
		/* translators: %s: The current WordPress version. */
		wp_die( sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', '***REMOVED***' ), $GLOBALS['wp_version'] ) );
	}
}
