...
function twentyseventeen_customize_preview_js() {
	wp_enqueue_script( '***REMOVED***-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js' ), array( 'customize-preview' ), '20161002', true );
}
...
function twentyseventeen_panels_js() {
	wp_enqueue_script( '***REMOVED***-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '20161020', true );
}
