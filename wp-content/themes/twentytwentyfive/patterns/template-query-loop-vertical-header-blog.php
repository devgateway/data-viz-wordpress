...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<div class="wp-block-column" style="flex-basis:70%"><!-- wp:post-excerpt {"moreText":"","***REMOVED***":false} /--></div>
		<!-- /wp:column -->
		...
		<!-- /wp:spacer -->
	<!-- /wp:post-template -->
	<!-- wp:query-pagination {"layout":{"type":"flex","***REMOVED***":"space-between","flexWrap":"wrap"}} -->
