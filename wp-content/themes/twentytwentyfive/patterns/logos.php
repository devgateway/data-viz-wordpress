...
<div class="wp-block-group alignfull is-style-section-1" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'The Stories Podcast is sponsored by', '***REMOVED***' ); ?></h2>
	<!-- /wp:heading -->
	...
	<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","flexWrap":"wrap","***REMOVED***":"center"}} -->
	<div class="wp-block-group alignwide">
		<!-- wp:image {"width":"150px","aspectRatio":"4/3","scale":"contain","***REMOVED***":"none"} -->
