 ...
 * Slug: ***REMOVED***/template-query-loop-text-blog
 * Inserter: no
 *
 * @package WordPress
...
<div class="wp-block-query alignwide">
	...
	<div class="wp-block-group alignfull" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40);">
		<!-- wp:query-pagination {"align":"full","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"layout":{"type":"flex","***REMOVED***":"space-between","flexWrap":"wrap"}} -->
