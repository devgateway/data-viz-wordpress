...
function wp_api_v2_menus_get_menu_items( $id ) {
	...
	foreach ( $menu_items as $key => $item ) {
        ...
        $item->menu_item_languages_type = get_post_meta($item->ID,'_menu_item_languages_type',true);
        $item->menu_item_languages_show = get_post_meta($item->ID,'_menu_item_languages_show',true);
