...
<h3 id="bsr-help-heading"><?php _e( 'Help & ***REMOVED***', 'better-search-replace' ); ?></h3>
...
<p><?php printf( __( 'For premium features and priority email support, <a href="%s" style="font-weight:bold;">upgrade to pro</a>.', 'better-search-replace' ), 'https://***REMOVED***.com/?utm_source=insideplugin&utm_medium=web&utm_content=help-tab&utm_campaign=pro-upsell' ); ?></p>

<p><?php printf( __( 'Found a bug or have a feature request? Please submit an issue on <a href="%s">GitHub</a>!', 'better-search-replace' ), 'https://github.com/***REMOVED***/better-search-replace' ); ?></p>
